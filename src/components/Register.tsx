        ...
        <section className="m-8 flex">
            ...
            <div className="w-full lg:w-3/5 flex flex-col items-center justify-center">
                <div className="text-center">
                    <Typography variant="h2" className="font-bold mb-4" placeholder={undefined}>Join Us Today</Typography>
                    <Typography variant="paragraph" color="blue-gray" className="text-lg font-normal" placeholder={undefined}>
                ...
                <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
                    ...
                    <Checkbox
                        label={<Typography
                            variant="small"
                            color="gray"
                            className="flex items-center justify-start font-medium" placeholder={undefined}>
                            I agree the&nbsp;
                            <a
                                href="#"
                    ...
                    <Button className="mt-6" fullWidth placeholder={undefined} onClick={handleRegister}>
                        Register Now
                    </Button>
